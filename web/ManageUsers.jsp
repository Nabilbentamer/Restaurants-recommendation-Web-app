...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="ressources/css/ManageUsers.css">
      ...
      <div class="card">
        <table id="customers">
          ...
          <tr>
            <td> ${member.uname}</td>
            <td>${member.email}</td>
            <td><a href="<%= request.getContextPath()%>/EditUser?UserId=${member.id}&action=delete"><i class="far fa-trash-alt delete"></i>Delete</a> </td>
            <td><a href="<%= request.getContextPath()%>/EditUser?UserId=${member.id}&action=edit"><i class="fas fa-user-edit edit"></i>Edit</a></td>
          </tr>
